...
const multiSelectVariants = cva('m-1 transition-all duration-300 ease-in-out', {
  variants: {
    variant: {
      default: 'border-foreground text-foreground bg-card hover:bg-card/80 font-medium',
      secondary:
        'border-foreground bg-secondary text-secondary-foreground hover:bg-secondary/80 font-medium',
      destructive:
        ...
        <Popover open={isPopoverOpen} onOpenChange={setIsPopoverOpen} modal={modalPopover}>
          ...
          <PopoverTrigger asChild>
            <Button
              ...
              className={cn(
                'flex p-1 rounded-md border min-h-10 h-auto items-center font-medium border-gray-200 justify-between bg-inherit hover:bg-inherit [&_svg]:pointer-events-auto',
          ...
          <PopoverContent
            ...
            style={{
              animationDuration: `${animationConfig?.duration || animation}s`,
              animationDelay: `${animationConfig?.delay || 0}s`,
              maxWidth: `min(${widthConstraints.maxWidth}, 33vw)`,
