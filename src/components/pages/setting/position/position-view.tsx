...
const PositionViewDetail = ({ id, onDataLoaded }: { id: string, onDataLoaded: (name: string) => void }): React.ReactNode => {
  ...
  return (
    <div className="w-full h-205 lg:h-190 grid grid-cols-1 lg:grid-cols-2 gap-10 lg:px-10 items-center">
      <div className="w-full h-95 lg:h-170 border px-7 py-5 rounded-sm text-lg">
        <div>
